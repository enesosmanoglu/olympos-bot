...
exports.run = async (client, message, args) => {
    ...
    let db0 = db.get(`ranks_606027252362379294.${args[0]}`)
    let db1 = db.get(`ranks_606027252362379294.aylık.${ay1}.${args[0]}`)
    let db2 = db.get(`ranks_606027252362379294.aylık.${ay2}.${args[0]}`)
    ...
    Object.keys(db1).forEach(userID => {
        ...
        if (exp2 > exp1) {
            desc.push(`<@${userID}>:\nNisan:**${exp1}**\nMayıs:**${exp2}**\nTOPLAM:**${exp0}**\nOlması Gereken Mayıs: **${exp0 - exp1}**\n`)
        }
    });
